 ...
 * The full license information can be found in LICENSE in the root directory of this project.
 */
const POPOVER_DIRECTIVES = [PopoverDirectiveOld, PopoverDirective];
...
class DatagridHeaderRenderer {
    ...
    clearWidth() {
        ...
        let /** @type {?} */ strictWidth = this.domAdapter.userDefinedWidth(this.el.nativeElement);
...
class DatagridMainRenderer {
    ...
    computeHeadersWidth() {
        ...
        this.headers.forEach((header, index) => {
            ...
            const /** @type {?} */ width = header.computeWidth();
 ...
 */
class DatagridRowMasterRenderer {
    /**
     * @param {?} outsideContainer
     * @param {?} organizer
     */
    constructor(outsideContainer, organizer) {
 ...
 * @nocollapse
 */
DatagridRowMasterRenderer.ctorParameters = () => [
    { type: ViewContainerRef, },
    { type: DatagridRenderOrganizer, },
];
 ...
 * The full license information can be found in LICENSE in the root directory of this project.
 */
const NAVIGATION_DIRECTIVES = [Header, NavLevelDirective];
...
class FocusTrapDirective {
     ...
     */
    constructor(elementRef, injector, focusTrapsTracker) {
        this.elementRef = elementRef;
...
export { FocusTrapTracker as ÇlrFocusTrapTracker, ClarityModule, ClrButtonModule, ClrButtonGroupModule, ClrLoadingButtonModule, ClrSyntaxHighlightModule, ClrDataModule, ClrDatagridModule, ClrStackViewModule, ClrTreeViewModule, ClrEmphasisModule, ClrAlertModule, ClrFormsModule, ClrIconModule, ClrLayoutModule, ClrMainContainerModule, ClrNavigationModule, ClrTabsModule, ClrModalModule, ClrPopoverModule, ClrDropdownModule, ClrTooltipModule, ClrWizardModule, ClrLoadingModule, ALERT_DIRECTIVES, Alert, AlertItem, BUTTON_GROUP_DIRECTIVES, LOADING_BUTTON_DIRECTIVES, CHECKBOX_DIRECTIVES, Checkbox, CODE_HIGHLIGHT_DIRECTIVES, CodeHighlight, DROPDOWN_DIRECTIVES, Dropdown, DropdownMenu, DropdownTrigger, DropdownItem, menuPositions, DATAGRID_DIRECTIVES, Datagrid, DatagridActionBar, DatagridActionOverflow, DatagridColumn, DatagridColumnToggle, DatagridHideableColumnDirective, DatagridFilter, DatagridItems, DatagridRow, DatagridRowDetail, DatagridCell, DatagridFooter, DatagridPagination, DatagridPlaceholder, SortOrder, DatagridStringFilter, DatagridPropertyStringFilter, DatagridPropertyComparator, TREE_VIEW_DIRECTIVES, TreeNode, STACK_VIEW_DIRECTIVES, StackView, StackViewCustomTags, StackHeader, StackBlock, StackInput, StackSelect, ICON_DIRECTIVES, LAYOUT_DIRECTIVES, MainContainer, MODAL_DIRECTIVES, Modal, NAVIGATION_DIRECTIVES, Header, NavLevelDirective, TABS_DIRECTIVES, Tabs, Tab, TabContent, TabOverflowContent, TabLinkDirective, TOOLTIP_DIRECTIVES, Tooltip, TooltipTrigger, TooltipContent, WIZARD_DIRECTIVES, Wizard, WizardPage, WizardStepnav, WizardStepnavItem, DEFAULT_BUTTON_TYPES, CUSTOM_BUTTON_TYPES, WizardButton, WizardHeaderAction, WizardCustomTags, WizardPageTitleDirective, WizardPageNavTitleDirective, WizardPageButtonsDirective, WizardPageHeaderActionsDirective, collapse, fade, fadeSlide, slide, LOADING_DIRECTIVES, Loading, LoadingListener, Button as ɵcr, ButtonGroup as ɵct, LoadingButton as ɵcq, ButtonInGroupService as ɵcs, ClrCodeModule as ɵcu, DatagridRowExpandAnimation as ɵcd, ActionableOompaLoompa as ɵca, DatagridWillyWonka as ɵby, ExpandableOompaLoompa as ɵcc, DatagridDetailRegisterer as ɵbn, CustomFilter as ɵbj, DragDispatcher as ɵbi, FiltersProvider as ɵy, ExpandableRowsCount as ɵbe, HideableColumnService as ɵbf, Items as ɵx, Page as ɵz, RowActionService as ɵbd, Selection as ɵw, Sort as ɵbb, StateDebouncer as ɵba, StateProvider as ɵbg, DatagridBodyRenderer as ɵbu, DatagridCellRenderer as ɵbw, DatagridColumnResizer as ɵbr, DomAdapter as ɵbp, DatagridHeadRenderer as ɵbt, DatagridHeaderRenderer as ɵbq, DatagridMainRenderer as ɵbo, DatagridRenderOrganizer as ɵbc, DatagridRowMasterRenderer as ɵbx, DatagridRowRenderer as ɵbv, DatagridTableRenderer as ɵbs, DatagridFilterRegistrar as ɵbh, StackControl as ɵch, AbstractTreeSelection as ɵci, clrTreeSelectionProviderFactory as ɵck, TreeSelectionService as ɵcj, AlertIconAndTypesService as ɵs, IconCustomTag as ɵa, clrResponsiveNavigationProvider as ɵcw, ClrResponsiveNavigationService as ɵcv, AriaService as ɵda, ActiveOompaLoompa as ɵdd, TabsWillyWonka as ɵdc, TabsService as ɵdb, VERTICAL_NAV_DIRECTIVES as ɵdf, VerticalNavGroupRegistrationService as ɵdm, VerticalNavGroupService as ɵdn, VerticalNavIconService as ɵdl, VerticalNavService as ɵdk, VerticalNav as ɵdh, VerticalNavGroup as ɵdg, VerticalNavGroupChildren as ɵdo, VerticalNavIcon as ɵdj, VerticalNavLink as ɵdi, ClrVerticalNavModule as ɵde, GHOST_PAGE_ANIMATION as ɵcp, AbstractPopover as ɵj, POPOVER_DIRECTIVES as ɵc, PopoverDirectiveOld as ɵd, PopoverDirective as ɵe, ClrCommonPopoverModule as ɵb, ROOT_DROPDOWN_PROVIDER as ɵi, RootDropdownService as ɵg, clrRootDropdownFactory as ɵh, SIGNPOST_DIRECTIVES as ɵdq, Signpost as ɵbl, SignpostContent as ɵdr, SignpostTriggerDirective as ɵbm, ClrSignpostModule as ɵdp, OompaLoompa as ɵcb, WillyWonka as ɵbz, ClrConditionalModule as ɵk, IfActiveDirective as ɵm, IF_ACTIVE_ID as ɵo, IF_ACTIVE_ID_PROVIDER as ɵq, IfActiveService as ɵr, tokenFactory as ɵp, IfOpenDirective as ɵn, IfOpenService as ɵf, CONDITIONAL_DIRECTIVES as ɵl, ClrIfExpandModule as ɵce, IfExpanded as ɵcg, EXPAND_DIRECTIVES as ɵcf, Expand as ɵbk, FocusTrapDirective as ɵcn, ClrFocusTrapModule as ɵcl, FOCUS_TRAP_DIRECTIVES as ɵcm, OUSTIDE_CLICK_DIRECTIVES as ɵu, OutsideClick as ɵv, ClrOutsideClickModule as ɵt, ScrollingService as ɵco, TEMPLATE_REF_DIRECTIVES as ɵcy, TemplateRefContainer as ɵcz, ClrTemplateRefModule as ɵcx, ButtonHubService as ɵdu, HeaderActionService as ɵdv, PageCollectionService as ɵdt, WizardNavigationService as ɵds };
